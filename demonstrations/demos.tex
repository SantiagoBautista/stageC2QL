...
\subsection*{Fragmentation et chiffrement nécessaire}
\begin{align}
...
& \text{si $\alpha \notin \delta$}
\end{align}
Les deux lois se démontrent de façons tout à fait symétrique,
...
$res_{1,1}$ et $res_{2,1}$ ont tous les deux pour schémas relationnels
$\delta_1 \cap \delta$
