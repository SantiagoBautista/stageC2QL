...
\subsubsection*{Deuxième inclusion}
Inversement, soit $l$ un élément de $res_2$.

Il existe $l'$ dans $\foldAlphafz(r)$
telle que $l = l'|_\dilta$ et $l''$ dans $r$
telle que $l' = \redu_{\alpha, f, z, l'}$. 

Puisque $l''$ appartient à $r$,
$l''|_\dilta$ appartient à $\projDelta(r)$
et $\redu_{alpha, f, z, l''|_\dilta}$, que l'on va appeler
$\tilde{l}$, appartient à $res_1$. \\

Par un calcul symétrique à celui de la démonstration de la
première inclusion,
on peut montrer que $\tilde{l} = l$.

Ainsi, $l$ appartient à $res_1$ et on a la deuxième inclusion.
