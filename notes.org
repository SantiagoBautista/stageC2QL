...
***** TODO Lire Ullman pour réfléchir à la pertinance des critères
...
INTUITION: Pour l'instant ça m'étonnerait que le système soit complet au premier sens
=> Pour l'instant on peut chercher des contre-exemples à la complétude,
et ajouter des lois
Pour le deuxième sens, je voudrais ajouter des lois pour le fold
