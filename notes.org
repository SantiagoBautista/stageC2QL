...
** TODO  Les identifiants post-jointure ne sont pas des identifiants
...
***** TODO Changer les définitions pour que id ne soit pas un attribut
...
peut-on (et aurait-on intérêt) à étendre C2QL pour
qu'il soit aussi expressif que privy?
...
*** Bilan de la journée
**** Instalation de idris, ghc, gmp, cabal..
...
Ils semblent être définis par un cas possible dans une définition de type...
...
**** TODO Ajouter des lois pour enlever les opérateurs qui trivialement n'agissent pas
