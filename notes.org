* Grandes lignes
0** Définir une notion de complétude pour les lois algébrique
*** Première idée: 
...
** 23/06
*** Objectifs de la journée
**** Reproductibilité, même si ça implique d'utiliser les Hole: Nat -> C2QL
...
*** Bilan de la journée
**** Échecs de reproductibilité
+ Aucune erreur n'est lancée pour l'exemple d'erreur dans l'implémentation de l'environement :/
